...
class ProductCreateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'skus.new1.description.between' => 'SKU1描述长度在2-150个字符中间',
            'skus.new1.name.between' => 'SKU1名称长度在2-150个字符中间',
            ...
            'skus.new2.description.between' => 'SKU2描述长度在2-150个字符中间',
            'skus.new2.name.between' => 'SKU2名称长度在2-150个字符中间',
        ];
    }
}
